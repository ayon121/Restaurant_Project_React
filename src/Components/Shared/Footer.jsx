    ...
    return (
        <div>
            <footer className="h-auto bg-main font-Nunito">
                ...
                <div className="max-w-6xl mx-auto px-4 pt-9 grid grid-cols-1 md:grid-cols-3 gap-3 items-center   ">
                    {/* logo */}
                    <div className="mt-8 md:mt-11 mb-4">
                    ...
                    <div className="col-span-2 mb-4">
                        <header className="footer-title text-highlight_color ">Social</header>
                        <div className="grid grid-cols-3 gap-3 w-6/12 text-sub_color_1">
