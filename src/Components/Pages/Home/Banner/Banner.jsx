            ...
            <div className="carousel w-full h-full bg-main bg-opacity-60 pb-4">
                <div id="slide1" className="carousel-item relative w-full ">
                    ...
                    <div className="flex justify-center items-center w-3/4 text-sub_color_1 max-w-5xl mx-auto">
                        <div className="">
                            <h1 className="text-3xl md:text-4xl lg:text-6xl py-2"> Where Every Bite Tells a Delicious Story! Join us at 
                    ...
                    <div className="absolute flex justify-between transform -translate-y-3/4 left-5 right-5 -bottom-1/3 top-3/4 ">
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="flex justify-center items-center w-3/4 text-sub_color_1 max-w-5xl mx-auto">
                        <div>
                            <h1 className="text-3xl md:text-4xl lg:text-6xl">Flavors that Speak Louder than Words: Elevate your dining experience at 
                            <a className="text-3xl md:text-4xl lg:text-6xl text-sub_color_1 font-Allura"><span className="text-highlight_color"> C</span>ulina</a>
                            </h1>
                            <p className="py-2">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="flex justify-center items-center w-3/4 text-sub_color_1 max-w-5xl mx-auto">
                        <div>
                            <h1 className="text-3xl md:text-4xl lg:text-6xl py-2"> Tantalize Your Taste Buds: Immerse yourself in the exquisite symphony of flavors at 
                            <a className=" text-3xl md:text-4xl lg:text-6xl text-sub_color_1 font-Allura"><span className="text-highlight_color"> C</span>ulina</a>
                            </h1>
